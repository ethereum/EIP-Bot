...
export const expectError = async (fn) => {
  ...
  if (!error) throw new Error(`function ${fn.toString()} was expected to throw and error but it didn't`)
}
...
export const FileFactory = (overrides: Partial<File> = {}): NonNullable<File> => {
  const defaults: File = {
    ...
    deletions: 5,
    changes: 10,
    blob_url: 'https://github.com/ethereum/EIPs/blob/f661efb56fee4a4cdffe1ba3efe119d19c0ae9a7/EIPS/eip-2930.md',
    raw_url: 'https://github.com/ethereum/EIPs/raw/f661efb56fee4a4cdffe1ba3efe119d19c0ae9a7/EIPS/eip-2930.md',
    contents_url: 'https://api.github.com/repos/ethereum/EIPs/contents/EIPS/eip-2930.md?ref=f661efb56fee4a4cdffe1ba3efe119d19c0ae9a7',
    patch: [
...
export const FileDiffFactory = (overrides: RecursivePartial<FileDiff>  = {}): FileDiff => {
  const defaults = {
    head: {
      eipNum: 2930,
